(function () {
  ...
  function buildSpecialLockingSvg(metrics = {}) {
    ...
    return [
      ...
      openings > 0 ? cadControlledDoorOpeningIcon({ x: 76, y: 154, scale: 0.42, tone: pressureTone }) : '',
      openings > 1 ? cadControlledDoorOpeningIcon({ x: 126, y: 154, scale: 0.42, tone: pressureTone }) : '',
