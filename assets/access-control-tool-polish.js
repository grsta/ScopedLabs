(function () {
  ...
  const VERSION = "access-control-tool-polish-015-square-status-chip-aliases";
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      "/* Access Control square status chip aliases v015 */",
      "body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .reader-type-status-chip,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .panel-capacity-status-chip,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .access-level-status-chip,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .credential-format-status-chip{align-items:center!important;border:1px solid rgba(255,204,102,.38)!important;border-radius:8px!important;background:rgba(255,204,102,.10)!important;color:rgba(255,220,120,.96)!important;display:inline-flex!important;font-size:.72rem!important;font-weight:840!important;justify-content:center!important;letter-spacing:.06em!important;line-height:1!important;min-height:22px!important;min-width:74px!important;padding:2px 12px!important;text-align:center!important;text-transform:uppercase!important;white-space:nowrap!important;width:fit-content!important;}",
      "body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .reader-type-status-chip.is-risk,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .panel-capacity-status-chip.is-risk,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .access-level-status-chip.is-risk,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .credential-format-status-chip.is-risk{background:rgba(255,105,105,.10)!important;border-color:rgba(255,105,105,.38)!important;color:rgba(255,150,150,.96)!important;}",
      "body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .reader-type-status-chip.is-watch,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .panel-capacity-status-chip.is-watch,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .access-level-status-chip.is-watch,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .credential-format-status-chip.is-watch{background:rgba(255,204,102,.10)!important;border-color:rgba(255,204,102,.38)!important;color:rgba(255,220,120,.96)!important;}",
      "body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .reader-type-status-chip.is-safe,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .reader-type-status-chip.is-healthy,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .panel-capacity-status-chip.is-safe,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .panel-capacity-status-chip.is-healthy,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .access-level-status-chip.is-safe,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .access-level-status-chip.is-healthy,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .credential-format-status-chip.is-safe,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .credential-format-status-chip.is-healthy{background:rgba(125,255,152,.10)!important;border-color:rgba(125,255,152,.38)!important;color:rgba(125,255,152,.96)!important;}",
      "body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .access-level-decision-hero .access-level-status-chip,body[data-category=\"access-control\"][data-access-control-tool-polish=\"true\"] .credential-format-decision-hero .credential-format-status-chip{display:inline-flex!important;width:fit-content!important;max-width:max-content!important;min-width:0!important;flex:0 0 auto!important;align-self:flex-start!important;justify-self:start!important;margin-top:0!important;}",
