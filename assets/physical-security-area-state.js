(() => {
  ...
  function bannerHtml(area, ledger) {
    if (!area) {
      return '<div class="card" style="margin-top:22px;border-color:rgba(255,211,79,.28);"><strong>Area Planner</strong><p class="muted" style="margin-bottom:0;">No active area selected. Start with Area / Zone Planner before using this guided flow.</p></div>';
    }
    ...
    return '' +
      '<div class="card" style="margin-top:22px;border-color:rgba(125,255,158,.20);background:rgba(125,255,152,.035);">' +
        ...
        '</div>' +
        '<h2 class="h3" style="margin-top:10px;color:rgba(255,255,255,.94);font-size:1.24rem;line-height:1.2;font-weight:700;">' + escapeHtml(area.name) + '</h2>' +
