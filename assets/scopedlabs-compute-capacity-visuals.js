...
(function () {
  ...
  function renderVmDensityCapacityEnvelope(target, result) {
    ...
    function footerIcon(type) {
      var iconStyle = ' fill="none" stroke="rgba(226,232,240,.70)" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"';
      if (type === "density") {
    ...
    function footerStat(x, icon, label, value, w) {
      return '<g transform="translate(' + x + ' 360)" data-vm-density-footer-icon-chip="0706"><rect width="' + w + '" height="40" rx="8" class="chip-bg"/>' + footerIcon(icon) + '<text x="38" y="16" class="chip-label">' + escapeXml(label) + '</text><text x="38" y="31" class="chip-value">' + escapeXml(value) + '</text></g>';
    }
