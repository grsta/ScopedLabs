...
check("shared", "Planning visual module is current", planning.includes("access-control-planning-visuals-060-access-level-matrix-layout"));
...
tools.forEach((slug) => {
  ...
  if (Object.prototype.hasOwnProperty.call(sharedVisualTools, slug)) {
    check(slug, "loads current shared planning visual", html.includes("/assets/access-control-planning-visuals.js?v=access-control-planning-visuals-060-access-level-matrix-layout"));
