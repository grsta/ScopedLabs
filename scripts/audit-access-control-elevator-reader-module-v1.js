...
check("Elevator Reader calculates total cars from topology model", script.includes("carsPerGroup") && script.includes("scopeCountInput") && script.includes("bankedCars") && script.includes("const separateCars = isMixedTopology ? separateLocations : 0") && script.includes("const cars = isMixedTopology ? bankedCars + separateCars : carsPerGroup * banks"));
...
check("Elevator Reader hides generic bank inputs for banks plus singles", html.includes("data-elevator-generic-count-field") && script.includes("setElevatorFieldHidden") && script.includes("setFieldHidden(els.cars, isBanksPlusSingles)") && script.includes("setFieldHidden(els.banks, isBanksPlusSingles)") && script.includes("Elevator Reader calculate failed"));
...
check("Elevator Reader reader overflow uses status tone", elevatorVisualBlock.includes("carOverflowLabel") && elevatorVisualBlock.includes('x="246" y="188" width="64"') && elevatorVisualBlock.includes("statusLineStroke"));
check("Elevator Reader banks plus singles visual label is explicit", elevatorVisualBlock.includes("BANKS + SINGLES") && elevatorVisualBlock.includes("lineGroupLabel"));
check("Elevator Reader keeps bank overflow label below icon row", elevatorVisualBlock.includes("elevatorOverflowLabel") && elevatorVisualBlock.includes('x="458" y="184" width="108"') && elevatorVisualBlock.includes('text-anchor="middle"'));
check("Elevator Reader keeps bank overflow label below icon row", elevatorVisualBlock.includes("elevatorOverflowLabel") && elevatorVisualBlock.includes('x="458" y="184" width="108"') && elevatorVisualBlock.includes('text-anchor="middle"'));
