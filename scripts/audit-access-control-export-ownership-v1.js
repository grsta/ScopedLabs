...
check("Fail-Safe cache points to current local script lane", html.includes("access-control-fail-safe-scope-input-hydration-015") && html.includes("./script.js?v=access-control-fail-safe-scope-input-hydration-015"));
