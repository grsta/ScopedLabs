...
check("Fail-Safe cache points to current local script lane", html.includes("./script.js?v=access-control-fail-safe-two-visuals-polish-019") && script.includes("access-control-fail-safe-two-visuals-polish-019"));
