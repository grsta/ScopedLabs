...
check("Fail-Safe cache points to current local script lane", html.includes("./script.js?v=access-control-fail-safe-status-scope-split-020") && script.includes("access-control-fail-safe-status-scope-split-020"));
