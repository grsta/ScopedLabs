...
check("Fail-Safe cache points to current local script lane", html.includes("access-control-fail-safe-output-contract-016") && html.includes("./script.js?v=access-control-fail-safe-output-contract-016"));
