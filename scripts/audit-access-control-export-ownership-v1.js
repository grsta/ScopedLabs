...
check("Fail-Safe cache points to current local script lane", html.includes("./script.js?v=access-control-fail-safe-two-visuals-018") && script.includes("access-control-fail-safe-two-visuals-018"));
