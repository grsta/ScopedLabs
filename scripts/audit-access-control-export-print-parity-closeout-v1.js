...
check("Planning visual module version bumped", planning.includes("access-control-planning-visuals-060-access-level-matrix-layout"));
...
check("Lock Power loads shared planning visual module", lockHtml.includes('/assets/access-control-planning-visuals.js?v=access-control-planning-visuals-060-access-level-matrix-layout'));
...
check("Scope Planner loads shared planning visual module", scopeHtml.includes('/assets/access-control-planning-visuals.js?v=access-control-planning-visuals-060-access-level-matrix-layout'));
