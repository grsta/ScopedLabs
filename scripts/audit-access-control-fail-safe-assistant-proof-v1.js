...
check("Assistant scripts load before local script", index.indexOf("scopedlabs-local-assistant.js") < index.indexOf("./script.js?v=access-control-fail-safe-two-visuals-018") && index.indexOf("access-control-tool-assistant-adapters.js") < index.indexOf("./script.js?v=access-control-fail-safe-two-visuals-018"));
...
check("Scoped assistant CSS added", style.includes("access-control-fail-safe-two-visuals-018") && style.includes(".scopedlabs-local-assistant-card"));
