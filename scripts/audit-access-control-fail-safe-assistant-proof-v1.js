...
check("Assistant scripts load before local script", index.indexOf("scopedlabs-local-assistant.js") < index.indexOf("./script.js?v=access-control-fail-safe-state-visual-017") && index.indexOf("access-control-tool-assistant-adapters.js") < index.indexOf("./script.js?v=access-control-fail-safe-state-visual-017"));
...
check("Scoped assistant CSS added", style.includes("access-control-fail-safe-state-visual-017") && style.includes(".scopedlabs-local-assistant-card"));
