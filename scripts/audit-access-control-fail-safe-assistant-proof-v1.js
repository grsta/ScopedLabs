...
check("Local script cache bumped", index.includes("./script.js?v=access-control-fail-safe-assistant-proof-contract-021"));
check("Style cache bumped", index.includes("/assets/style.css?v=access-control-fail-safe-assistant-proof-contract-021"));
check("Assistant scripts load before local script", index.indexOf("scopedlabs-local-assistant.js") < index.indexOf("./script.js?v=access-control-fail-safe-assistant-proof-contract-021") && index.indexOf("access-control-tool-assistant-adapters.js") < index.indexOf("./script.js?v=access-control-fail-safe-assistant-proof-contract-021"));
...
check("Scoped assistant CSS added", style.includes("access-control-fail-safe-assistant-proof-contract-021") && style.includes(".scopedlabs-local-assistant-card"));
