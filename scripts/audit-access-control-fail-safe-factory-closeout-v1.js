...
check("Assistant card is Access Control scoped", engine.includes("access-control-local-assistant-card") && adapters.includes("access-control-assistant-adapters-002-factory-closeout"));
