...
check("Assistant card is Access Control scoped", engine.includes("access-control-local-assistant-card") && adapters.includes("access-control-assistant-adapters-025-assistant-proof-contract"));
...
check("Closeout CSS present", style.includes("access-control-fail-safe-fail-secure-preview-print-batch-001"));
