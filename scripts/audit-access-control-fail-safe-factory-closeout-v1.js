...
check("Assistant card is Access Control scoped", engine.includes("access-control-local-assistant-card") && adapters.includes("access-control-assistant-adapters-024-assistant-proof-pattern-extract"));
...
check("Closeout CSS present", style.includes("access-control-fail-safe-status-scope-split-020"));
