...
check("Reusable Access Control polish asset exists", polish.includes("ScopedLabsAccessControlToolPolish") && polish.includes("access-control-tool-polish-006-fail-safe-rich-assistant-shell"));
check("Fail-Safe loads reusable polish asset", html.includes("/assets/access-control-tool-polish.js?v=access-control-tool-polish-006-fail-safe-rich-assistant-shell"));
