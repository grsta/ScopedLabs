...
check("Fail-Safe hero status chip is content-width", html.includes("access-control-fail-safe-status-scope-split-020") && html.includes(".fail-safe-decision-hero .fail-safe-status-chip") && html.includes("width: fit-content") && html.includes("align-items: flex-start"));
