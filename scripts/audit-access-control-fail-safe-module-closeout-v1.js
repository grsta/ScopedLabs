...
check("Report metadata init runs before tool script", html.indexOf("ScopedLabsReportMetadata.init") < html.indexOf("./script.js?v=access-control-fail-safe-assistant-proof-contract-021"));
