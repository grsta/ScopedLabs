...
check("Fail-Safe cache bumped to final shell polish lane", html.includes("access-control-fail-safe-state-visual-017") && html.includes("./script.js?v=access-control-fail-safe-state-visual-017"));
...
check("Report metadata init runs before tool script", html.indexOf("ScopedLabsReportMetadata.init") < html.indexOf("./script.js?v=access-control-fail-safe-state-visual-017"));
