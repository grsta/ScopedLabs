...
check("Report metadata init runs before tool script", html.indexOf("ScopedLabsReportMetadata.init") < html.indexOf("./script.js?v=access-control-fail-safe-fail-secure-preview-print-batch-001"));
