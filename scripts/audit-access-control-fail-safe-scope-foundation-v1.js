...
check("Fail-Safe cache bumped to scope foundation lane", html.includes("access-control-fail-safe-scope-foundation-001") && html.includes("./script.js?v=access-control-fail-safe-scope-foundation-001"));
