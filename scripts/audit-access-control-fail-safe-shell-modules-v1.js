...
check("Fail-Safe cache bumped to shell modules lane", html.includes("access-control-fail-safe-state-visual-017") && html.includes("./script.js?v=access-control-fail-safe-state-visual-017"));
