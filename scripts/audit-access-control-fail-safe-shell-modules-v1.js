...
check("Fail-Safe cache bumped to shell modules lane", html.includes("access-control-fail-safe-status-scope-split-020") && html.includes("./script.js?v=access-control-fail-safe-status-scope-split-020"));
