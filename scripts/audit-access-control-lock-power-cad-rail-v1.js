...
check("Lock Power local script cache is CAD rail lane", html.includes("./script.js?v=access-control-lock-power-cad-power-rail-025"));
...
check("CAD renderer creates DC rail", script.includes("function dcPowerRail") && script.includes("CURRENT FLOW"));
