...
check('Shared module is on module version 016', moduleText.includes(version));
check('Door Count page loads shared module version 016', doorCountHtml.includes('/assets/access-control-planning-visuals.js?v=' + version));
check('Door Cable page loads shared module version 016', doorCableHtml.includes('/assets/access-control-planning-visuals.js?v=' + version));
