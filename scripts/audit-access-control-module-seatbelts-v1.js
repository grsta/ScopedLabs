...
check('Shared module is on module version 011', moduleText.includes(version));
check('Door Count page loads shared module version 011', doorCountHtml.includes('/assets/access-control-planning-visuals.js?v=' + version));
check('Door Cable page loads shared module version 011', doorCableHtml.includes('/assets/access-control-planning-visuals.js?v=' + version));
