...
const version = 'access-control-planning-visuals-022-special-locking-icon-drop';
...
check('Shared module is on module version 022', moduleText.includes(version));
check('Door Count page loads shared module version 022', doorCountHtml.includes('/assets/access-control-planning-visuals.js?v=' + version));
check('Door Cable page loads shared module version 022', doorCableHtml.includes('/assets/access-control-planning-visuals.js?v=' + version));
