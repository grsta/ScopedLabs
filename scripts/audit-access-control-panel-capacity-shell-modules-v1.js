...
check("Panel Capacity local script cache is shell module lane", html.includes("./script.js?v=access-control-panel-capacity-output-contract-022"));
...
check("Panel Capacity script order keeps assistant modules before local script", order(html, "/assets/access-control-tool-assistant-adapters.js?v=access-control-assistant-adapters-012-panel-capacity-adapter", "./script.js?v=access-control-panel-capacity-output-contract-022"));
check("Panel Capacity script order keeps polish after local script", order(html, "./script.js?v=access-control-panel-capacity-output-contract-022", "/assets/access-control-tool-polish.js?v=access-control-tool-polish-010-page-chrome-pill-cleanup"));
