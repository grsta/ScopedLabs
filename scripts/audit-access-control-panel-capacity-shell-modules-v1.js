...
check("Panel Capacity loads Panel adapter cache", html.includes("/assets/access-control-tool-assistant-adapters.js?v=access-control-assistant-adapters-019-elevator-reader"));
...
check("Panel Capacity script order keeps assistant modules before local script", order(html, "/assets/access-control-tool-assistant-adapters.js?v=access-control-assistant-adapters-019-elevator-reader", "./script.js?v=access-control-panel-capacity-cad-schedule-024"));
