...
check("Panel Capacity loads Panel adapter cache", html.includes("/assets/access-control-tool-assistant-adapters.js?v=access-control-assistant-adapters-012-panel-capacity-adapter"));
...
check("Panel Capacity loads Access Control polish module", html.includes("/assets/access-control-tool-polish.js?v=access-control-tool-polish-009-export-title-card-reference"));
check("Panel Capacity local script cache is shell module lane", html.includes("./script.js?v=access-control-panel-capacity-shell-modules-021"));
...
check("Panel Capacity script order keeps assistant modules before local script", order(html, "/assets/access-control-tool-assistant-adapters.js?v=access-control-assistant-adapters-012-panel-capacity-adapter", "./script.js?v=access-control-panel-capacity-shell-modules-021"));
check("Panel Capacity script order keeps polish after local script", order(html, "./script.js?v=access-control-panel-capacity-shell-modules-021", "/assets/access-control-tool-polish.js?v=access-control-tool-polish-009-export-title-card-reference"));
