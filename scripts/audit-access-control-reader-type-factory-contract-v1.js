...
check("Reader Type page uses current factory lane", html.includes("access-control-reader-type-factory-016-watch-label-polish") && html.includes("./script.js?v=access-control-reader-type-factory-016-watch-label-polish"));
