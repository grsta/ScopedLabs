...
check("Reader Type page uses current factory lane", html.includes("access-control-reader-type-factory-017-watch-text-tone") && html.includes("./script.js?v=access-control-reader-type-factory-017-watch-text-tone"));
