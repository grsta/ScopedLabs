...
check("Scope Planner summary includes branch-map visual", index.includes("/assets/access-control-planning-visuals.js?v=access-control-planning-visuals-052-assistant-proof-pattern-extract") && script.includes("buildScopePlannerBranchMapHtml") && script.includes("ScopedLabsAccessControlPlanningVisuals"));
