...
check("Elevator Reader overflow label is centered off the status line", moduleText.includes("elevatorOverflowLabel") && moduleText.includes('x="458" y="184" width="108"') && moduleText.includes('text-anchor="middle"'));
...
check("Elevator Reader reader overflow uses status tone", moduleText.includes("carOverflowLabel") && moduleText.includes('x="246" y="188" width="64"') && moduleText.includes("statusLineStroke"));
check("Elevator Reader banks plus singles visual label is explicit", moduleText.includes("BANKS + SINGLES") && moduleText.includes("lineGroupLabel"));
