...
const VERSION = "area-planner-summary-ui-polish-audit-012-report-group-count-defined";
...
add(
  ...
  ((index.includes("physical-security-area-planner-summary-ui-015") || index.includes("physical-security-area-planner-summary-ui-015")) || (index.includes("physical-security-area-planner-summary-ui-015") || index.includes("physical-security-area-planner-summary-ui-015")))
    ? "SAFE"
    : "FAIL",
