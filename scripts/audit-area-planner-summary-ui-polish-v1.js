...
add(
  ...
  ((index.includes("physical-security-area-planner-summary-ui-014") || index.includes("physical-security-area-planner-summary-ui-014")) || (index.includes("physical-security-area-planner-summary-ui-014") || index.includes("physical-security-area-planner-summary-ui-014")))
    ? "SAFE"
    : "FAIL",
