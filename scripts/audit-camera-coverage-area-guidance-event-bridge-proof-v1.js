...
const auditVersion = "camera-coverage-area-guidance-event-bridge-proof-audit-001";

const indexFile = path.join(root, "tools", "physical-security", "camera-coverage-area", "index.html");
const scriptFile = path.join(root, "tools", "physical-security", "camera-coverage-area", "script.js");
...
const rows = [
  {
    ...
    detail: "Coverage Area index exists"
  },
  {
    id: "memory-loaded",
    ...
    detail: "Coverage Area loads shared guidance memory"
  },
  {
    ...
    detail: "Coverage Area loads current memory-aware category guidance"
  },
  {
    id: "bridge-loaded",
    ...
    detail: "Coverage Area loads shared guidance event bridge"
  },
  {
    id: "bridge-singleton",
  ...
  {
    id: "local-cache",
    status: html.includes("./script.js?v=physical-security-coverage-guidance-event-bridge-001-nonvisible") ? "SAFE" : "WATCH",
    detail: "Coverage Area local script cache bumped"
  },
  {
    id: "adapter-global-preserved",
    status: js.includes("ScopedLabsCameraCoverageAreaGuidance") && js.includes("getLastGuidance") ? "SAFE" : "WATCH",
    detail: "Coverage Area guidance adapter global remains available"
  },
  {
    id: "publish-helper",
    status:
      js.includes("function publishCameraCoverageAreaGuidanceEvent") &&
      js.includes("ScopedLabsPhysicalSecurityGuidanceEventBridge") &&
      js.includes("publishIfChanged") &&
      js.includes('tool: "camera-coverage-area"') ? "SAFE" : "WATCH",
    detail: "Coverage Area can publish validated guidance through event bridge"
  },
  {
    id: "publish-hook",
    status:
      js.includes("updateCameraCoverageAreaUserGuidance(data);") &&
      js.includes('publishCameraCoverageAreaGuidanceEvent("camera-coverage-area-guidance-update")') ? "SAFE" : "WATCH",
    detail: "Coverage Area publishes after validated guidance update"
  },
  {
    id: "raw-edit-clear",
    status:
      js.includes("function clearCameraCoverageAreaGuidanceEventMemory") &&
      js.includes('bridge.clearTool("camera-coverage-area")') &&
      js.includes("clearCameraCoverageAreaGuidanceEventMemory();") ? "SAFE" : "WATCH",
    detail: "Coverage Area clears stale memory on raw edits"
  },
  {
    ...
    detail: "Coverage Area does not add visible category renderer"
  },
  {
  ...
  },
  {
    ...
    detail: "Coverage Area event bridge proof adds no runtime web fetch"
  }
];

console.log("\nCamera Coverage Area Guidance Event Bridge Proof Audit\n");
