...
const indexRel = "tools/physical-security/camera-coverage-area/index.html";
const scriptRel = "tools/physical-security/camera-coverage-area/script.js";
...
add(checks, "index-exists", index ? "SAFE" : "FAIL", index ? "Camera Coverage Area index exists" : "Missing Camera Coverage Area index");
add(checks, "script-exists", localScript ? "SAFE" : "FAIL", localScript ? "Camera Coverage Area script exists" : "Missing Camera Coverage Area script");
...
[
  ...
  add(
    ...
    has(index, asset) ? "Camera Coverage Area loads " + asset : "Camera Coverage Area missing " + asset
  );
});
...
add(
  ...
  "Camera Coverage Area has dedicated local assistant mount"
);
...
add(
  ...
  "Camera Coverage Area local script cache points to " + VERSION
);
...
[
  ...
  "cameraCoverageAreaLocalAssistantProof",
  "buildModel",
  "render",
  "clear"
...
add(
  ...
  "Camera Coverage Area does not load visible category/master renderer"
);
...
add(
  ...
  "Camera Coverage Area does not load category report summary helper"
);
...
console.log("");
console.log("Camera Coverage Area Local Assistant Proof Audit");
