...
check(results, moduleSrc.includes("scopedlabs-compute-capacity-visuals-008-cpu-ram-clean-family"), "MODULE_VERSION_003_CPU_RAM_ENVELOPE", moduleFile);
...
check(results, ramIndex.includes("/assets/scopedlabs-compute-capacity-visuals.js?v=scopedlabs-compute-capacity-visuals-008-cpu-ram-clean-family"), "RAM_INDEX_LOADS_VERSIONED_SHARED_CAPACITY_MODULE", ramIndexFile);
