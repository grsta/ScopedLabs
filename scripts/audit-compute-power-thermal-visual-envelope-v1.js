...
check("POWER_THERMAL_VISUAL_LABEL_FIT", src.visuals.includes('{ key: "limit", x: 616') && src.visuals.includes('labelLift = point.key === "limit" ? 30 : 16') && src.visuals.includes('text-anchor="start" class="limit-label">100% usable limit') && src.visuals.includes('translate(\' + x + \' 382)') && src.visuals.includes('height="404" rx="18" class="panel"'), "Power / Thermal visual should move high-risk labels away from the right edge and give footer text breathing room.");
...
check("POWER_THERMAL_VISUAL_ASSET_CACHE_BUST", src.html.includes("scopedlabs-compute-capacity-visuals.js?v=scopedlabs-compute-capacity-visuals-033-power-thermal-label-fit") && src.html.includes("script.js?v=compute-power-thermal-visual-envelope-0708"), "Power / Thermal should load cache-busted visual and local script assets.");
