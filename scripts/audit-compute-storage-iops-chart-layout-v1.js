...
check("STORAGE_IOPS_RESULT_CACHE_BUST_RAM_PARITY", html.includes("script.js?v=compute-storage-iops-export-interpretation-layout-0705"));
...
check("STORAGE_IOPS_SCRIPT_CACHE_BUST_SHARED_RESULT_CARD", html.includes("script.js?v=compute-storage-iops-export-interpretation-layout-0705"));
...
check("STORAGE_IOPS_SCRIPT_CACHE_BUST_RAM_REFERENCE_FLOW", html.includes("script.js?v=compute-storage-iops-export-interpretation-layout-0705"));
...
check("STORAGE_IOPS_SCRIPT_CACHE_BUST_RAM_SECTION_CONTRACT", html.includes("script.js?v=compute-storage-iops-export-interpretation-layout-0705"));
let pass = 0;
let fail = 0;
