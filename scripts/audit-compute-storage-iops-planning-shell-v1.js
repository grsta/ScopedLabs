...
[
  ...
  "compute-storage-iops-ram-shell-template-0704"
...
check("CONTINUE_TO_STORAGE_THROUGHPUT_PRESENT", html.includes('data-compute-continue-href="/tools/compute/storage-throughput/"') && html.includes("Continue &rarr; Storage Throughput"));

ordered("RAM_SHELL_SECTION_ORDER", [
...
check("STORAGE_IOPS_MODULE_MAP_ENTRY", moduleMap.includes("COMPUTE_STORAGE_IOPS_RAM_SHELL_TEMPLATE_0704"));
...
console.log("");
console.log("SCOPEDLABS COMPUTE STORAGE IOPS RAM SHELL STRUCTURE AUDIT V1");
