...
check("STORAGE_IOPS_EXPORT_INTERPRETATION_REPORT_SECTION_LAYOUT", js.includes("function buildStorageIopsInterpretationExportSection") && js.includes('title: "Engineering Interpretation"') && js.includes('description: "Concise Storage IOPS interpretation for report review."') && js.includes('.join("\\n\\n");'));
check("STORAGE_IOPS_EXPORT_INTERPRETATION_AFTER_DECISION_SCHEDULE", js.includes("buildStorageIopsDecisionScheduleExportSection(),\n      buildStorageIopsInterpretationExportSection(result)") && js.includes('interpretation: ""') && js.includes("analysisSections: []"));
check("STORAGE_IOPS_EXPORT_INTERPRETATION_LAYOUT_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-layout-0705'));
check("STORAGE_IOPS_CUSTOM_EXPORT_RESOLVES_REQUIRED_IOPS_FROM_REPORT_ROWS", js.includes("function resolveStorageIopsExportResult") && js.includes('storageIopsExportDecisionValue("Required IOPS")') && js.includes('storageIopsExportRowValue(outputs, ["Estimated Required IOPS", "Required IOPS"])') && js.includes("next.finalIops = requiredIops") && js.includes("next.requiredIops = requiredIops"));
check("STORAGE_IOPS_CUSTOM_EXPORT_RESOLVES_AVAILABLE_UTILIZATION_LATENCY_BLOCK", js.includes('storageIopsExportDecisionValue("Available IOPS")') && js.includes('storageIopsExportDecisionValue("Utilization")') && js.includes('storageIopsExportDecisionValue("Latency Target")') && js.includes('storageIopsExportDecisionValue("Block Size")'));
check("STORAGE_IOPS_CUSTOM_EXPORT_DATA_FIX_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-layout-0705'));
check("STORAGE_IOPS_CUSTOM_EXPORT_PAYLOAD_BUILDER", html.includes('"customPayloadBuilder": "ScopedLabsComputeStorageIopsExport.buildPayload"') && js.includes("window.ScopedLabsComputeStorageIopsExport") && js.includes("buildStorageIopsExportPayload") && js.includes("currentStorageIopsExportResult"));
check("STORAGE_IOPS_CUSTOM_EXPORT_INTERPRETATION_CLEAN", js.includes("buildStorageIopsExportInterpretation") && js.includes("required IOPS exceeds the entered available platform IOPS") && js.includes("Carry forward: use"));
check("STORAGE_IOPS_CUSTOM_EXPORT_ANALYSIS_SECTIONS_CLEAN", js.includes("buildStorageIopsExportAnalysisSections") && js.includes('title: "Why it matters"') && js.includes('title: "Recommended correction"') && js.includes('title: "Carry forward"'));
check("STORAGE_IOPS_CUSTOM_EXPORT_SECTIONS_MATCH_ACCEPTED_UI", js.includes("buildStorageIopsVisualExportSection") && js.includes("buildStorageIopsReferenceExportSection") && js.includes("buildStorageIopsRecommendedActionsExportSection") && js.includes("buildStorageIopsDecisionScheduleExportSection") && js.includes('exportSectionsContract: "storage-iops-visual-references-actions-schedule"'));
check("STORAGE_IOPS_CUSTOM_EXPORT_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-layout-0705'));
check("STORAGE_IOPS_EXPORT_OLD_ANALYZER_INTERPRETATION_SUPPRESSED", js.includes("function suppressStorageIopsAnalyzerInterpretationSource") && js.includes('data-storage-iops-export-analysis-source-suppressed", "0705"') && js.includes("suppressStorageIopsAnalyzerInterpretationSource();") && js.indexOf("suppressStorageIopsAnalyzerInterpretationSource();") < js.indexOf("renderStorageIopsExportInterpretation({"));
check("STORAGE_IOPS_EXPORT_INTERPRETATION_SPACING_CLEANED", js.includes('].join("\\n");') && js.includes("<p><strong>Status:</strong>") && js.includes("<p><strong>Why it matters:</strong>"));
check("STORAGE_IOPS_EXPORT_INTERPRETATION_SOURCE_CLEAN_CACHE_BUST", html.includes('script.js?v=compute-storage-iops-export-interpretation-layout-0705'));
check("STORAGE_IOPS_EXPORT_INTERPRETATION_STRUCTURED", js.includes("function renderStorageIopsExportInterpretation") && js.includes('data-storage-iops-export-interpretation-structured="0705"') && js.includes("<p><strong>Status:</strong>") && js.includes("<p><strong>Why it matters:</strong>") && js.includes("<p><strong>Carry forward:</strong>") && js.includes("renderStorageIopsExportInterpretation({"));
check("STORAGE_IOPS_EXPORT_INTERPRETATION_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-layout-0705'));
...
check("STORAGE_IOPS_EXPORT_SCRIPT_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-layout-0705'));
