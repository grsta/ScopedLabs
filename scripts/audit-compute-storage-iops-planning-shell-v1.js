...
check("STORAGE_IOPS_EXPORT_INTERPRETATION_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-0705'));
...
check("STORAGE_IOPS_EXPORT_SCRIPT_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-export-interpretation-0705'));
