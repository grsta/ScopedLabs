...
check("STORAGE_IOPS_CUSTOM_EXPORT_DATA_FIX_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-custom-export-data-fix-0705'));
...
check("STORAGE_IOPS_CUSTOM_EXPORT_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-custom-export-data-fix-0705'));
...
check("STORAGE_IOPS_EXPORT_INTERPRETATION_SOURCE_CLEAN_CACHE_BUST", html.includes('script.js?v=compute-storage-iops-custom-export-data-fix-0705'));
...
check("STORAGE_IOPS_EXPORT_INTERPRETATION_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-custom-export-data-fix-0705'));
...
check("STORAGE_IOPS_EXPORT_SCRIPT_CACHE_BUST_UPDATED", html.includes('script.js?v=compute-storage-iops-custom-export-data-fix-0705'));
