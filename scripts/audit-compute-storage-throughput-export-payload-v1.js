...
check("HTML_SCRIPT_CACHE_BUSTED", html.includes("compute-storage-throughput-export-payload-0705") || html.includes("compute-storage-throughput-shell-parity-0705") || html.includes("compute-storage-throughput-planner-routing-0706") || html.includes("compute-shell-storage-throughput-promotion-0706"));
