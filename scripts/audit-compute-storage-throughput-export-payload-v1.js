...
check("HTML_SCRIPT_CACHE_BUSTED", ((html.includes("compute-storage-throughput-export-payload-0705") || html.includes("compute-shell-contract-storage-flow-next-0705")) || (html.includes("compute-shell-contract-storage-throughput-next-0705") || html.includes("compute-shell-contract-storage-flow-next-0705"))) || ((html.includes("compute-storage-throughput-shell-parity-0705") || html.includes("compute-shell-contract-storage-flow-next-0705")) || (html.includes("compute-shell-contract-storage-throughput-next-0705") || html.includes("compute-shell-contract-storage-flow-next-0705"))));
