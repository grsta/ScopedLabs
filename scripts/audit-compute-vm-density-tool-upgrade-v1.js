...
check("VM_DENSITY_SCRIPT_CACHE_BUSTED", (src.html.includes("compute-vm-density-tool-upgrade-0706") || src.html.includes("compute-vm-density-planning-inputs-0706")), "VM Density local script should be cache-busted for this upgrade.");
