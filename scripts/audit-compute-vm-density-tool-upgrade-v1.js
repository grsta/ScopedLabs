...
check("VM_DENSITY_SCRIPT_CACHE_BUSTED", src.html.includes("compute-vm-density-tool-upgrade-0706"), "VM Density local script should be cache-busted for this upgrade.");
check("VM_DENSITY_KB_CARD_PRESENT", src.html.includes("vm-density-kb-card-0706") && src.html.includes("VM Density Guide") && src.html.includes("Open KB Guide"), "VM Density should have a KB guide card.");
