...
check("VM_DENSITY_SCRIPT_CACHE_BUSTED", (src.html.includes("compute-vm-density-tool-upgrade-0706") || src.html.includes("compute-vm-density-planning-inputs-0706") || src.html.includes("compute-vm-density-renderer-parity-075") || src.html.includes("compute-vm-density-renderer-parity-076")), "VM Density local script should be cache-busted for this upgrade.");
...
check("VM_DENSITY_LOCAL_RENDER_HOOKS", src.script.includes("renderVmDensityCapacityVisual(vmDensityResult)") && src.script.includes("renderVmDensityRecommendedActions(vmDensityResult)") && src.script.includes("renderVmDensityDecisionSchedule(vmDensityResult)"), "VM Density script should render shared visual plus RAM-style assistant actions and decision schedule output.");
