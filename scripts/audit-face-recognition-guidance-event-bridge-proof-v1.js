...
const auditVersion = "face-recognition-guidance-event-bridge-proof-audit-001";

const indexFile = path.join(root, "tools", "physical-security", "face-recognition-range", "index.html");
const scriptFile = path.join(root, "tools", "physical-security", "face-recognition-range", "script.js");
...
const rows = [
  {
    ...
    detail: "Face Recognition index exists"
  },
  {
    id: "memory-loaded",
    ...
    detail: "Face Recognition loads shared guidance memory"
  },
  {
    ...
    detail: "Face Recognition loads current memory-aware category guidance"
  },
  {
    id: "bridge-loaded",
    ...
    detail: "Face Recognition loads shared guidance event bridge"
  },
  {
    id: "bridge-singleton",
  ...
  {
    id: "local-cache",
    status: html.includes("./script.js?v=physical-security-face-guidance-event-bridge-001-nonvisible") ? "SAFE" : "WATCH",
    detail: "Face Recognition local script cache bumped"
  },
  {
    id: "adapter-global-preserved",
    status: js.includes("ScopedLabsFaceRecognitionGuidance") && js.includes("getLastGuidance") ? "SAFE" : "WATCH",
    detail: "Face Recognition guidance adapter global remains available"
  },
  {
    id: "publish-helper",
    status:
      js.includes("function publishFaceRecognitionGuidanceEvent") &&
      js.includes("ScopedLabsPhysicalSecurityGuidanceEventBridge") &&
      js.includes("publishIfChanged") &&
      js.includes('tool: "face-recognition-range"') ? "SAFE" : "WATCH",
    detail: "Face Recognition can publish validated guidance through event bridge"
  },
  {
    id: "publish-hook",
    status:
      js.includes("updateFaceRecognitionUserGuidance(data);") &&
      js.includes('publishFaceRecognitionGuidanceEvent("face-recognition-guidance-update")') ? "SAFE" : "WATCH",
    detail: "Face Recognition publishes after validated guidance update"
  },
  {
    id: "raw-edit-clear",
    status:
      js.includes("function clearFaceRecognitionGuidanceEventMemory") &&
      js.includes('bridge.clearTool("face-recognition-range")') &&
      js.includes("clearFaceRecognitionGuidanceEventMemory();") ? "SAFE" : "WATCH",
    detail: "Face Recognition clears stale memory on raw edits"
  },
  {
    id: "structured-export-preserved",
    status: js.includes("renderFaceStructuredExport(data);") && js.indexOf("renderFaceStructuredExport(data);") < js.indexOf("writeFlow(data);") ? "SAFE" : "WATCH",
    detail: "Face Recognition structured export remains before writeFlow"
  },
  {
    ...
    detail: "Face Recognition does not add visible category renderer"
  },
  {
  ...
  },
  {
    ...
    detail: "Face Recognition event bridge proof adds no runtime web fetch"
  }
];

console.log("\nFace Recognition Guidance Event Bridge Proof Audit\n");
