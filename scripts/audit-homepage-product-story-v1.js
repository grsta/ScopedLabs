...
has("cad-target-hfov-style", "Homepage", index, 'fill="rgba(235,245,239,.45)" font-size="10.8">Target distance: 60 ft</text>');
has("cad-raw-hfov-style", "Homepage", index, 'fill="rgba(235,245,239,.45)" font-size="10.8">Raw: 120 ft</text>');
has("cad-reserve-muted-style", "Homepage", index, 'fill="rgba(239,211,106,.62)" font-size="10.8">Reserve 9 ft</text>');
has("cad-usable-muted-style", "Homepage", index, 'fill="rgba(113,255,121,.62)" font-size="10.8">Usable Width: 102ft</text>');
