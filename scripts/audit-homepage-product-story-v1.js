...
const VERSION = "homepage-product-story-026-workflow-direction-lines";
const STYLE_CACHE = "homepage-product-story-026-workflow-direction-lines";
...
has("main-marker", "Homepage", index, "homepage-product-story-026-workflow-direction-lines");
...
has("style-marker", "style.css", style, "homepage-product-story-026-workflow-direction-lines");
...
add("workflow-halo-removed", !style.includes("homepage-product-story-026-workflow-direction-lines") && !style.includes("homepage-product-story-026-workflow-direction-lines"), "Planning Workflow halo experiment removed");
...
has("proof-band-stripe-removed", "style.css", style, "homepage-product-story-026-workflow-direction-lines");
...
has("cad-inner-fit-css", "style.css", style, "homepage-product-story-026-workflow-direction-lines");
...
has("cad-css-marker", "style.css", style, "homepage-product-story-026-workflow-direction-lines");
