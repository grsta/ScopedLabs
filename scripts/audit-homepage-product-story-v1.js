...
has("cad-descriptor-size-bumped", "Homepage", index, 'font-size="11.6">Target distance: 60 ft</text>');
has("cad-right-label-size-bumped", "Homepage", index, 'font-size="11.6">Raw: 120 ft</text>');
has("cad-usable-size-bumped", "Homepage", index, 'font-size="11.6">Usable Width: 102ft</text>');
has("cad-target-hfov-style", "Homepage", index, 'fill="rgba(235,245,239,.45)" font-size="11.6">Target distance: 60 ft</text>');
has("cad-raw-hfov-style", "Homepage", index, 'fill="rgba(235,245,239,.45)" font-size="11.6">Raw: 120 ft</text>');
has("cad-reserve-muted-style", "Homepage", index, 'fill="rgba(239,211,106,.62)" font-size="11.6">Reserve 9 ft</text>');
has("cad-usable-muted-style", "Homepage", index, 'fill="rgba(113,255,121,.62)" font-size="11.6">Usable Width: 102ft</text>');
add("cad-descriptor-heavy-weights-removed", !/font-weight="(?:400|700|800|850|900|bold)"[^>]*>(Target distance: 60 ft|Reserve 9 ft|Raw: 120 ft|Usable Width: 102ft)<\/text>/.test(index), "Homepage CAD descriptor text does not use heavy font-weight attributes");
