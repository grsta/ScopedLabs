...
const VERSION = "homepage-product-story-010-proof-width-and-graph-fit";
const STYLE_CACHE = "homepage-product-story-010-proof-width-and-graph-fit";
...
has("main-marker", "Homepage", index, "homepage-product-story-010-proof-width-and-graph-fit");
...
has("style-marker", "style.css", style, "homepage-product-story-010-proof-width-and-graph-fit");
...
has("cad-css-marker", "style.css", style, "homepage-product-story-010-proof-width-and-graph-fit");
