...
const VERSION = "homepage-product-story-021-top-mid-scale-tuning";
const STYLE_CACHE = "homepage-product-story-021-top-mid-scale-tuning";
...
has("main-marker", "Homepage", index, "homepage-product-story-021-top-mid-scale-tuning");
...
has("style-marker", "style.css", style, "homepage-product-story-021-top-mid-scale-tuning");
...
has("proof-band-stripe-removed", "style.css", style, "homepage-product-story-021-top-mid-scale-tuning");
...
has("cad-inner-fit-css", "style.css", style, "homepage-product-story-021-top-mid-scale-tuning");
...
has("cad-css-marker", "style.css", style, "homepage-product-story-021-top-mid-scale-tuning");
