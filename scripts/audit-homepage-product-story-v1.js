...
const VERSION = "homepage-product-story-015-proof-gap-width-balance";
const STYLE_CACHE = "homepage-product-story-015-proof-gap-width-balance";
...
has("main-marker", "Homepage", index, "homepage-product-story-015-proof-gap-width-balance");
...
has("style-marker", "style.css", style, "homepage-product-story-015-proof-gap-width-balance");
...
has("cad-inner-fit-css", "style.css", style, "homepage-product-story-015-proof-gap-width-balance");
...
has("cad-css-marker", "style.css", style, "homepage-product-story-015-proof-gap-width-balance");
