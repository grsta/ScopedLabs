...
const VERSION = "homepage-product-story-016-proof-header-spacing";
const STYLE_CACHE = "homepage-product-story-016-proof-header-spacing";
...
has("main-marker", "Homepage", index, "homepage-product-story-016-proof-header-spacing");
...
has("style-marker", "style.css", style, "homepage-product-story-016-proof-header-spacing");
...
has("cad-inner-fit-css", "style.css", style, "homepage-product-story-016-proof-header-spacing");
...
has("cad-css-marker", "style.css", style, "homepage-product-story-016-proof-header-spacing");
