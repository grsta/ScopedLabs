...
has("assets/style.css", "chrome-style-marker", style, "landing-page-chrome-polish-001");
...
for (const rel of uniqueTargets) {
  ...
  has(rel, "style-cache", html, "/assets/style.css?v=landing-page-chrome-polish-001");
  has(rel, "chrome-marker", html, "landing-page-chrome-polish-001");
