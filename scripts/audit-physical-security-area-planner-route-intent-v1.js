...
const VERSION = "physical-security-area-planner-route-intent-audit-002-button-scroll-cache";
...
add(
  ...
  (index.includes("physical-security-area-planner-route-intent-001") || index.includes("physical-security-area-planner-button-scroll-002"))
    ? "SAFE"
    : "FAIL",
