...
const VERSION = "physical-security-area-planner-summary-button-retired-audit-001";
...
safe("script-cache-bumped", index.includes("script.js?v=physical-security-area-planner-summary-button-retired-019"), "Area Planner script cache bumped");
safe("retirement-marker", index.includes("physical-security-area-planner-summary-button-retired-019"), "Area Planner retirement marker exists");
