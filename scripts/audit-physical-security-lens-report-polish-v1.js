...
["id=\"lensReportSummaryExport\"", "data-export-title=\"Lens Selection Engineering Summary\"", "/assets/export.js?v=shared-export-014-print-safe-compact-svg", "./script.js?v=physical-security-lens-summary-cta-state-014", "id=\"lensDesignAssistant\"", "Continue → Physical Security Summary"].forEach((signal) => requireSignal("lens-index", lensIndex, signal));
