...
["id=\"lensReportSummaryExport\"", "data-export-title=\"Lens Selection Engineering Summary\"", "/assets/export.js?v=shared-export-024-report-text-wrap", "./script.js?v=physical-security-lens-summary-cta-state-015", "id=\"lensDesignAssistant\"", "Continue → Physical Security Summary"].forEach((signal) => requireSignal("lens-index", lensIndex, signal));
