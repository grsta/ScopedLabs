...
add("summary-version", asset.includes("physical-security-report-summary-001") ? "SAFE" : "FAIL", "summary helper version marker");
...
add("camera-spacing-loads-summary-helper", cameraIndex.includes("physical-security-report-summary.js?v=physical-security-report-summary-001") ? "SAFE" : "FAIL", "Camera Spacing loads report summary helper");
