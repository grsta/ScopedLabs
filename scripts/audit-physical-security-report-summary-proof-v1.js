...
add("summary-version", asset.includes("physical-security-report-summary-007-watch-risk-columns") ? "SAFE" : "FAIL", "summary helper version marker");
...
add("summary-detail-table", asset.includes("data-sl-physical-security-report-summary-detail-table") ? "SAFE" : "FAIL", "watch/risk detail renders as its own highlighted export table");
add("summary-detail-columns", asset.includes("<th>Tool</th><th>Status</th><th>Required Action</th><th>Detail / Next Step</th>") ? "SAFE" : "FAIL", "watch/risk detail uses printer-friendly structured columns");
...
add("camera-spacing-loads-summary-helper", cameraIndex.includes("physical-security-report-summary.js?v=physical-security-report-summary-007-watch-risk-columns") ? "SAFE" : "FAIL", "Camera Spacing loads report summary helper");
