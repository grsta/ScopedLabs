...
const VERSION = "physical-security-summary-area-rollup-first-audit-001";
...
safe("script-cache-bumped", index.includes("./script.js?v=physical-security-summary-area-rollup-first-004"), "Summary script cache bumped");
safe("script-version-bumped", script.includes("const VERSION = \"physical-security-summary-area-rollup-first-004\";"), "Summary script version bumped");
...
safe("area-first-order", orderBlock.indexOf("renderAreaSection(\"Core Coverage Areas\"") >= 0 && orderBlock.indexOf("renderAreaSection(\"Core Coverage Areas\"") < orderBlock.indexOf("renderRows(\"Core Pipeline Tool Guidance\""), "area/zone sections render before core pipeline tool guidance");
safe("specialty-before-tool-appendix", orderBlock.indexOf("renderAreaSection(\"License Plate Zones\"") >= 0 && orderBlock.indexOf("renderAreaSection(\"License Plate Zones\"") < orderBlock.indexOf("renderRows(\"Core Pipeline Tool Guidance\""), "specialty zones render before tool guidance appendix");
