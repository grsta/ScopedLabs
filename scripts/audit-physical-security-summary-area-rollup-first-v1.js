...
const VERSION = "physical-security-summary-area-rollup-first-audit-003-selector-rail-polish";
...
safe("selector-rail-style", index.includes("physical-security-summary-area-selector-rail-polish-009") && index.includes(".summary-area-selector-rail") && index.includes(".summary-area-selector-step.active"), "selector rail styles exist");
