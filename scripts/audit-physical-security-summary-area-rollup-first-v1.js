...
const VERSION = "physical-security-summary-area-rollup-first-audit-002-selector-rail";
...
safe("script-cache-bumped", index.includes("./script.js?v=physical-security-summary-area-selector-rail-005"), "Summary script cache bumped");
safe("script-version-bumped", script.includes("const VERSION = \"physical-security-summary-area-selector-rail-005\";"), "Summary script version bumped");
...
safe("selector-rail-style", index.includes("physical-security-summary-area-selector-rail-008") && index.includes(".summary-area-selector-rail") && index.includes(".summary-area-selector-step.active"), "selector rail styles exist");
