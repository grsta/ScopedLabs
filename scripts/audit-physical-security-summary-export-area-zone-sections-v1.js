...
const VERSION = "physical-security-summary-export-area-zone-sections-audit-001";
const REPORT_VERSION = "physical-security-report-summary-011-area-zone-sections";
...
safe("watch-risk-area-source", report.includes("function buildScopedActionRows()") && report.includes("scopeTitle(area, group, index)") && report.includes("buildGlobalActionRows(summary)"), "watch/risk action rows prefer scoped area/zone context");
