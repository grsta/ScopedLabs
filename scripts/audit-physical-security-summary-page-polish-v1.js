...
safe("script-version-remains", index.includes("./script.js?v=physical-security-summary-area-selector-rail-005") && script.includes("physical-security-summary-area-selector-rail-005"), "Summary script version/cache remains current");
