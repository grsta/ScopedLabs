...
safe("script-version-remains", index.includes("./script.js?v=physical-security-summary-area-selector-rail-polish-006") && script.includes("physical-security-summary-area-selector-rail-polish-006"), "Summary script version/cache remains current");
