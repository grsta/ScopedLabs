...
safe("script-version-remains", index.includes("./script.js?v=physical-security-summary-area-selector-flow-007") && script.includes("physical-security-summary-area-selector-flow-007"), "Summary script version/cache remains current");
