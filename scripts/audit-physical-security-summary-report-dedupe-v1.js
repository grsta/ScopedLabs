...
safe("physical-report-body-preserved", buildReportHTML.includes("${extraSectionsBlock}") && index.includes("physical-security-report-summary-028-area-step-header-cell"), "Physical Security report body remains exported through extra sections");
