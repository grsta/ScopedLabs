...
safe("physical-report-body-preserved", buildReportHTML.includes("${extraSectionsBlock}") && index.includes("physical-security-report-summary-024-report-carryover-values"), "Physical Security report body remains exported through extra sections");
