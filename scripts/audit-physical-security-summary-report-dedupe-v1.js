...
safe("physical-report-body-preserved", buildReportHTML.includes("${extraSectionsBlock}") && index.includes("physical-security-report-summary-022-area-ledger-fallback"), "Physical Security report body remains exported through extra sections");
