...
const VERSION = "physical-security-summary-report-status-text-audit-012-area-detail-contract";
...
safe("report-cache-bumped", index.includes("/assets/physical-security-report-summary.js?v=physical-security-report-summary-020-area-detail-contract"), "report summary cache bumped");
safe("report-version-bumped", report.includes("physical-security-report-summary-020-area-detail-contract"), "report summary version bumped");
