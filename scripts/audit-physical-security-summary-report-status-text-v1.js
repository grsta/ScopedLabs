...
const VERSION = "physical-security-summary-report-status-text-audit-011-detail-labels";
...
safe("report-cache-bumped", index.includes("/assets/physical-security-report-summary.js?v=physical-security-report-summary-019-detail-labels"), "report summary cache bumped");
safe("report-version-bumped", report.includes("physical-security-report-summary-019-detail-labels"), "report summary version bumped");
