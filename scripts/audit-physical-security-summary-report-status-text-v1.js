...
const VERSION = "physical-security-summary-report-status-text-audit-001";
...
safe("report-version-bumped", report.includes("physical-security-report-summary-009-status-text"), "report summary version bumped");
