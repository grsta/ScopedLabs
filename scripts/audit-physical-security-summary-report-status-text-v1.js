...
const VERSION = "physical-security-summary-report-status-text-audit-012-action-next-steps";
...
safe("report-cache-bumped", index.includes("/assets/physical-security-report-summary.js?v=physical-security-report-summary-024-report-carryover-values"), "report summary cache bumped");
safe("report-version-bumped", report.includes("physical-security-report-summary-024-report-carryover-values"), "report summary version bumped");
...
safe("category-status-row-colored", report.includes("[\"Status\", renderReportStatusText(summaryStatus), true]"), "category summary status row uses colored text");
