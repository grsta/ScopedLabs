...
const VERSION = "physical-security-summary-report-table-polish-audit-006-priority-scope";
...
safe("report-cache-bumped", index.includes("/assets/physical-security-report-summary.js?v=physical-security-report-summary-012-priority-scope"), "report summary cache bumped");
safe("report-version-bumped", report.includes("physical-security-report-summary-012-priority-scope"), "report summary asset version bumped");
