...
const VERSION = "pixel-density-local-assistant-proof-001";
const MOUNT_ID = "pixelDensityLocalAssistantMount";
...
const indexRel = "tools/physical-security/pixel-density/index.html";
const scriptRel = "tools/physical-security/pixel-density/script.js";
...
add(checks, "index-exists", index ? "SAFE" : "FAIL", index ? "Pixel Density index exists" : "Missing Pixel Density index");
add(checks, "script-exists", localScript ? "SAFE" : "FAIL", localScript ? "Pixel Density script exists" : "Missing Pixel Density script");
...
[
  ...
  add(
    ...
    has(index, asset) ? "Pixel Density loads " + asset : "Pixel Density missing " + asset
  );
});
...
add(
  ...
  "Pixel Density has dedicated local assistant mount"
);
...
add(
  ...
  "Pixel Density local script cache points to " + VERSION
);
...
[
  ...
  "pixelDensityLocalAssistantProof",
  "buildModel",
  "render",
  "clear"
...
add(
  ...
  "Pixel Density does not load visible category/master renderer"
);
...
add(
  ...
  "Pixel Density does not load category report summary helper"
);
...
console.log("");
console.log("Pixel Density Local Assistant Proof Audit");
