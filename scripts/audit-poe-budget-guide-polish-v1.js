...
check('Guide stylesheet cache bust updated', html.includes('/assets/style.css?v=poe-guide-polish-003-planning-check-steps'));
...
check('Scoped CSS block present', css.includes('poe-guide-polish-003-planning-check-steps'));
