...
check('Guide page scoped class present', html.includes('poe-guide-polish') && html.includes('poe-guide-clean-detail'));
check('Guide stylesheet cache bust updated', html.includes('/assets/style.css?v=poe-guide-polish-002-clean-detail'));
...
check('Quick answer section present', html.includes('id="quick-answer-title"') && html.includes('powered device load + safety margin'));
...
check('Scoped CSS block present', css.includes('poe-guide-polish-002-clean-detail'));
check('Scoped CSS guarded to PoE clean-detail body', css.includes('body.poe-guide-clean-detail .guide-layout'));
check('Single-column guide layout enforced', css.includes('grid-template-columns: 1fr'));
