...
const commands = [
  ["node", ["--check", "tools/compute/cpu-sizing/script.js"]],
  ["node", ["--check", "scripts/audit-compute-cpu-planner-routing-closeout-v1.js"]],
  ["node", ["scripts/audit-compute-cpu-planner-routing-closeout-v1.js"]]
];

const optional = [
  "scripts/audit-compute-cpu-capacity-visual-v1.js",
  "scripts/audit-compute-cpu-export-payload-v1.js",
  "scripts/audit-compute-cpu-shell-consumption-v1.js",
...
console.log("Compute CPU planner-routing closeout");
