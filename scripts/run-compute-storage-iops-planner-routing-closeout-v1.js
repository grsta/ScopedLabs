...
const commands = [
  ["node", ["--check", "tools/compute/storage-iops/script.js"]],
  ["node", ["--check", "scripts/audit-compute-storage-iops-planner-routing-closeout-v1.js"]],
  ["node", ["scripts/audit-compute-storage-iops-planner-routing-closeout-v1.js"]]
];

const optional = [
  "scripts/audit-compute-storage-iops-capacity-visual-v1.js",
  "scripts/audit-compute-storage-iops-proof-stack-v1.js",
  "scripts/audit-compute-storage-iops-export-payload-v1.js",
  "scripts/audit-compute-storage-iops-shell-parity-v1.js",
  "scripts/audit-compute-storage-iops-top-chrome-cleanup-v1.js",
...
console.log("Compute Storage IOPS planner-routing closeout");
