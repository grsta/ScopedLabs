...
const checks = [
  ...
  { label: "Storage Throughput proof stack audit", command: "node", args: [".\\scripts\\audit-compute-storage-throughput-proof-stack-v1.js"] },
...
console.log("");
console.log("Storage Throughput proof stack closeout");
