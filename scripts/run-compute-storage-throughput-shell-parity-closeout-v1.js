...
const checks = [
  ...
  { label: "Storage Throughput shell parity audit", command: "node", args: [".\\scripts\\audit-compute-storage-throughput-shell-parity-v1.js"] },
...
console.log("");
console.log("Storage Throughput shell parity closeout");
