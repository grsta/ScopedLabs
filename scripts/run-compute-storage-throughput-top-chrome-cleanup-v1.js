...
const checks = [
  ...
  { label: "Storage Throughput export payload closeout", command: "node", args: [".\\scripts\\run-compute-storage-throughput-export-payload-closeout-v1.js"] },
  ...
  { label: "Storage Throughput top chrome cleanup audit", command: "node", args: [".\\scripts\\audit-compute-storage-throughput-top-chrome-cleanup-v1.js"] },
...
console.log("");
console.log("Storage Throughput top chrome cleanup closeout");
