// access-control-anti-passback-zones-export-print-ux-001: local print report wording and page-pack polish.
(() => {
      ...
      ? `
        <section class="section">
          ...
          <div class="chart-wrap">
            <img src="${payload.chartImage}" alt="Anti-Passback Zones planning visual">
          </div>
        </section>
      `
      : "";
