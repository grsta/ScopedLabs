...
Provides planning guidance on common credential formats and security levels.
...
## Notes
- Run from project root: visit \/tools/access-control/credential-format/\
"@
