(() => {
  ...
  // access-control-scope-planner-print-disclaimer-keep-028
  ...
  function hydrateElevatorReaderSeed(scope = {}) {
    ...
    if (els.elevatorMixedCarsPerSeparateLocation) els.elevatorMixedCarsPerSeparateLocation.value = "1";
  ...
  function decorateScopeWithElevatorReaderSeed(scope) {
    ...
    return {
      ...
      elevatorMixedCarsPerSeparateLocation: 1,
...
'    .status-pill{display:inline-flex;align-items:center;justify-content:center;border-radius:10px;font-weight:720;letter-spacing:.06em;text-transform:uppercase;border:1px solid transparent;white-space:nowrap;padding:7px 13px;font-size:.78rem}' +
...
'    @media print{@page{size:landscape;margin:.38in}body{background:#fff;padding:0}.page{max-width:none;border:none;box-shadow:none}.toolbar{display:none !important}.report{padding:0}.brand-row{margin-bottom:0}.brand-mark{width:20px;height:20px;border-radius:5px}.brand-name{font-size:1rem}.tagline{font-size:.74rem;margin-bottom:7px}.report-head{padding:8px 0 9px;margin-bottom:10px}.report-title{font-size:1.32rem;margin-bottom:4px}.report-meta{font-size:.72rem;line-height:1.28}h2{font-size:1.05rem;margin:0 0 7px}.access-scope-branch-map-shell{max-width:9.4in;margin:0 auto 7px!important;break-inside:avoid;page-break-inside:avoid}.access-scope-branch-map-shell svg{display:block;width:100%;height:auto;max-height:3.9in}.access-scope-branch-map-shell .sl-vis-note{font-size:.68rem;line-height:1.22;margin:3px 0 0}.access-scope-summary-rollup{grid-template-columns:repeat(6,minmax(0,1fr));gap:6px;margin-bottom:7px}.access-scope-summary-metric{border-radius:9px;padding:7px}.access-scope-summary-label{font-size:.55rem;margin-bottom:3px}.access-scope-summary-value{font-size:1rem;font-weight:720}.access-scope-summary-note{font-size:.6rem;line-height:1.18}.access-status-legend{margin-top:7px;margin-bottom:0;padding-top:7px}.access-status-legend-title{font-size:.68rem;margin-bottom:4px}.access-status-legend-grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:4px 8px}.access-status-legend-item{font-size:.6rem;line-height:1.18}.access-scope-warn,.access-authority-caution{font-size:.66rem;line-height:1.22;padding:6px 8px;margin:5px 0}.access-scope-summary-branch{break-inside:avoid;page-break-inside:avoid;margin-top:12px;padding-top:0}.access-scope-summary-branch + .access-scope-summary-branch{margin-top:14px}.access-scope-summary-branch-head{margin-bottom:5px}.access-scope-summary-branch-head h3{font-size:1.08rem}.access-scope-summary-branch-count{font-size:.68rem}.access-scope-branch-description{font-size:.72rem;margin:0 0 6px;line-height:1.25}table.access-scope-summary-table{font-size:.68rem}.access-scope-summary-table th,.access-scope-summary-table td{padding:5px 6px}.section h2{break-after:avoid;page-break-after:avoid}.section:last-of-type{break-inside:avoid;page-break-inside:avoid;margin-top:12px}.section:last-of-type .access-scope-warn{break-inside:avoid;page-break-inside:avoid}.foot{font-size:.68rem;line-height:1.35;margin-top:10px;padding-top:8px;break-inside:avoid;page-break-inside:avoid}}' +
'  </style>' +
'</head>' +
'<body>' +
'  <div class="page">' +
