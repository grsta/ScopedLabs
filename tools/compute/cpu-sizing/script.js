(() => {
  ...
  function cpuVisualStatus(status) {
    const value = String(status || "PENDING").toUpperCase();
    if (value === "RISK") return { label: "RISK", fill: "rgba(248,113,113,.16)", line: "rgba(248,113,113,.82)", text: "rgba(206,32,41,.96)" };
