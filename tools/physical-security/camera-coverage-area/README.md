...
Calculates approximate coverage area based on mounting height, lens, and horizontal field of view.
...
## Notes
- Run from project root: visit \/tools/physical-security/camera-coverage-area/\
"@
