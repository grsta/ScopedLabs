...
Computes camera field of view based on sensor size and focal length.
...
## Notes
- Run from project root: visit \/tools/physical-security/field-of-view/\
"@
